...
export async function flagIncorrectGrouping(productId: number, externalProductId: number): Promise<void> {
    const response = await fetch(`/api/products/${productId}/externals/${externalProductId}/flag`, {
        method: 'POST',
        headers: {
